...
chapter: CH02
clip: 03
slides: s10,s17,s11,s12,s18,s24,s25,s26
status: ✅ 대본완성
---
...
Claude Code 전용 템플릿을 808개 모아둔 곳이에요.
스킬뿐 아니라 에이전트, 커맨드, MCP, 훅까지 카테고리별로 찾을 수 있어요.

화면에서 보이는 것처럼 인기 순서로 정렬되고, 설명도 같이 나와서 골라 쓰기가 편해요.
