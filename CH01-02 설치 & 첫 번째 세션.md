...
> - [Anthropic 콘솔](https://console.anthropic.com) — API 키 발급
...
node -v
```
18 미만이거나 없으면 [nodejs.org](https://nodejs.org)에서 LTS 버전 설치하면 됩니다.

**Anthropic API 키**
[console.anthropic.com](https://console.anthropic.com) → API Keys → 키 발급 후 복사해두세요.
