...
첫 번째, 엠씨피가 무엇인지, 왜 필요한지 설명할 수 있습니다.
두 번째, 파일시스템 엠씨피를 설치하고 에이전트와 연결할 수 있습니다.
...
> 📎 **참고 링크**
> - [MCP 공식 사이트](https://modelcontextprotocol.io) — 프로토콜 스펙과 개념 설명
> - [MCP GitHub 저장소](https://github.com/modelcontextprotocol) — 공식 서버 코드
> - [Claude Code MCP 문서](https://docs.anthropic.com/en/docs/claude-code/mcp) — 클로드 코드에서 MCP 사용법
...
첫 번째, 데이터베이스에서 직접 데이터를 가져오는 작업입니다.
에스큐엘 쿼리를 실행해서 테이블을 읽어야 합니다.

두 번째, 슬랙으로 분석 결과를 자동 전송하는 작업입니다.
분석이 끝나면 팀 채널에 리포트를 보내야 합니다.

세 번째, 구글 스프레드시트를 읽고 쓰는 작업입니다.
...
| 서버 | 기능 | 링크 |
|------|------|------|
| `@modelcontextprotocol/server-filesystem` | 파일 읽기/쓰기 | [GitHub](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) |
| `@modelcontextprotocol/server-postgres` | 포스트그레에스큐엘 연결 | [GitHub](https://github.com/modelcontextprotocol/servers/tree/main/src/postgres) |
| `@modelcontextprotocol/server-sqlite` | 에스큐라이트 연결 | [GitHub](https://github.com/modelcontextprotocol/servers/tree/main/src/sqlite) |
| `@modelcontextprotocol/server-slack` | 슬랙 메시지 전송 | [GitHub](https://github.com/modelcontextprotocol/servers/tree/main/src/slack) |
| `@modelcontextprotocol/server-github` | 깃허브 레포 연결 | [GitHub](https://github.com/modelcontextprotocol/servers/tree/main/src/github) |

> 💡 **더 많은 MCP 서버 찾기**: [MCP 서버 목록](https://github.com/modelcontextprotocol/servers) 에서 40개 이상의 공식/커뮤니티 서버를 확인할 수 있습니다.
